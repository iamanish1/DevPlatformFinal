...
const currentPage = "carrier"; 
  // State for Dropdowns
  const [selectedEvent, setSelectedEvent] = useState("MentorShip Type");
  const [isEventDropdownOpen, setIsEventDropdownOpen] = useState(false);

  const [selectedLocation, setSelectedLocation] = useState(" choose Type");
      ...
      <div className="flex justify-between mt-[8vmin] gap-x-[10vmin]">
        ...
        <div className="h-[100%] w-[75vmin] bg-white ml-[2vmin]">
          <h1 className="text-center text-[3vmin] font-bold mt-[3vmin]">
            <span className="text-[#4C1A76]">MentorShip</span> 
        ...
        <div className="w-full">
          <div>
            ...
            <div className="flex flex-wrap justify-start gap-4 mt-4">
              <div className="flex-shrink-0 w-full h-[60vmin] bg-white rounded-lg shadow-md">
                {/* Card Content */}
              </div>
              <div className="flex-shrink-0 w-full h-[60vmin] bg-white rounded-lg shadow-md">
                {/* Card Content */}
